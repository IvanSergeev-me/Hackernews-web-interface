...
const CommentTree: FunctionComponent<ICommentTreeProps> = ({commentId, depth, maxDepth}) => {
    ...
    return ( 
        <>
            <CommentDisplay key={commentId} {...commentWithChildren as CommentWithChildren} toggleExpand={toggleExpand} isExpanded={isExpanded} canExpand={canExpand} maxDepth={maxDepth}/>
            <div>
