...
const Comment: FunctionComponent<ICommentProps> = ({
  by,
  kidsCount,
  text,
  time,
      ...
      <div className={style.comment_container}>
        <div className={style.comment_container__top}>
          <p className={style.commnet_info_wrapper}>
            ...
            <span className={style.commnet_info_wrapper__date}>
              {timeToDisplay}
            </span>
          </p>
        </div>
        ...
        {canExpand && (
          <div className={style.comment_container__bottom}>
            <hr></hr>
            <div>
              <p className={style.commnet_info_wrapper}>
                <span className={style.commnet_info_wrapper__text}>
                  Replies:{" "}
                </span>
                <span className={style.commnet_info_wrapper__value}>
                  {kidsCount}
                </span>
              </p>
              <ExpandButton
                onButtonClick={toggleExpand}
