...
const DropdownSelect: FunctionComponent<IDropdownSelectProps> = ({
  name,
  id,
  onChange,
  options,
  ...
  const [currentValue, setCurrentValue] = useState<SelectOptionValue>(
    ...
    <div className={style.dropdown_container}>
      {label && (
        <div className={style.label_wrapper}>
          <label className={style.label} about={id}>
            {label}
          </label>
        </div>
      )}
